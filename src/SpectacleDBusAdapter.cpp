...
void SpectacleDBusAdapter::ClipboardActiveWindow(bool includeWindowDecorations, bool includeMousePointer)
{
...
void SpectacleDBusAdapter::ClipboardRectangularRegion(bool includeMousePointer)
{
    parent()->setCopyToClipboard(true);
    parent()->takeNewScreenshot(Spectacle::CaptureMode::RectangularRegion, 0, includeMousePointer, false);
}
